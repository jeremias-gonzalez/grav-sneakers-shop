...
import logo from "/public/imgs/logo-redesign.png"
                  ...
                  <div className='md:flex '>
                   <div className='flex flex-col justify-center my-10'>
                    ...
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        ...
                        <a href="https://www.instagram.com/grav.sneakers/" target='_bank' className="block  text-gray-900 transition-all duration-500 hover:text-custom-blue ">
